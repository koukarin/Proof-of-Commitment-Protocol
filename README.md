...
First of all, let’s consider the Proof-of-Work (PoW) and Proof-of-Stake (PoS). These consensus play two key roles :
...
To use the PoCoP and to aspire to receive rewards, ergonauts have to register a valid Ergo Address here: [https://app.ergone.io/dashboard](https://ergone.herokuapp.com/dashboard)
...
We decided to NOT reward the members proportionally to their virality score. Indeed, on most social media platforms, 0.5% of content creators grab 99% of the revenues.
